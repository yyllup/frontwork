      ...
      <div class="front-header-center">
        <div class="front-header-nav">
          <el-menu :default-active="$route.path" mode="horizontal" router>
            ...
            <el-menu-item index="/front/findSquare">招领广场</el-menu-item>
            <el-menu-item index="/front/suggestion">平台建议</el-menu-item>
            <el-menu-item index="/front/news">校园资讯</el-menu-item>
          </el-menu>
        </div>
      </div>
      <div>
        ...
        <div v-else>
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item>
                <div style="text-decoration: none" @click="navTo('/front/myFind')">我的招领</div>
              </el-dropdown-item>
              <el-dropdown-item>
