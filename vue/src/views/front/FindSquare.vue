<template>
  <div class="main-content">
    <div style=" width:80%;margin: 20px auto">
      <div style="color: darkblue; font-size: 25px;font-weight: 550">欢迎来到招领广场，如果您看到自己的物品，请尽快联系捡到的小伙伴！！！</div>
            ...
            <div class="transition card">
              <div style="display: flex" ><!--由于后台还没有设置好现在使用静态处理-->
                ...
                <div style="margin-left: 5px;font-size: 20px;color: #666">
                    <span style="margin-right: 5px;cursor: pointer;" @click="setFlower(item)" :class="{'active':item.userFlower}"><i class="el-icon-flower"></i>{{item.flowerCount}}</span>
                </div>
              </div>
              <div style="margin-top: 20px;text-align: center">
                <el-button type="info" size="mini" @click="viewContent(item.content)">查看详情</el-button>
                <el-button type="success" size="mini" @click="contact(item)">联系拾到者</el-button>
              </div>
            </div>
          </el-col>
        </el-row>
